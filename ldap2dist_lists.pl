...
my $sr = $ldap->search(base => "dc=domain,dc=org", filter => "(&(objectclass=sdpStudent)(|(uid=0000001)(uid=0000002)(uid=0000003)(uid=0000004)(uid=0000005)(uid=0000006)(uid=0000007)))", 
		      attrs => "uid");
